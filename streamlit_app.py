...
st.markdown(
    ...
    .section{border:1px solid var(--line);border-radius:32px;padding:34px 34px;background:rgba(11,26,18,.72);box-shadow:0 20px 70px rgba(0,0,0,.22);margin:24px 0;}
    ...
    .contact{border:1px solid var(--line);border-radius:36px;padding:48px;background:linear-gradient(135deg,rgba(82,255,154,.12),rgba(2,6,4,.95));text-align:center;margin:28px 0 6px 0;}
